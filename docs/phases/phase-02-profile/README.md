...
> **Superseded (Phase 5):** аватар и имя профиля перенесены в онлайн-лобби. Настройки оставляют тему / колоду / звуки.

## Цель

Экран настроек: тема, колода, звуки. (Исторически также аватар — снят в Phase 5.)
